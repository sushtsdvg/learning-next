...
const getCardData = (): propsType[] => {
  return [
    ...
    },
    {
      ...
      subtitle: "Kubernetes Autoscaling",
      description:
        "Intelligent Remediation for autoscaling and efficient service automation",
      button: {
        primaryButton: {
          text: "Try Smart Scaler",
          url: "",
        },
        secondaryButton: {
          text: "Learn",
